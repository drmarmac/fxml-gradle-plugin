...
public abstract class ProcessFxmlTask extends DefaultTask {
    ...
    public abstract static class FxmlFilesPerSourceDirectory {
        @Internal
    ...
    @Nested
    public abstract ListProperty<FxmlFilesPerSourceDirectory> getFxmlFilesPerSourceDirectory();
    ...
    public void process() {
        ...
        try {
            ...
            compiler.addFiles(getFxmlFilesPerSourceDirectory().get().stream()
                .collect(Collectors.toMap(x -> x.getSourceDir().get().getAsFile(),
